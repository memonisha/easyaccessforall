...
export default function DayPage({ params }: DayPageProps) {
  ...
  const completedActivities = totalActivities // Show as if all are accessible
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">{dayData.title}</h1>
          <p className="text-xl text-muted-foreground mb-6">{dayData.theme}</p>
          <div className="flex items-center justify-center gap-2 text-lg">
            <Users className="w-5 h-5 text-primary" />
            <span>
              Today you'll help <strong>{dayData.persona}</strong>, {dayData.personaDescription}
            </span>
          </div>
        </div>
      </section>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        <p className="font-medium text-foreground mb-2">Your Task:</p>
                        <p className="text-muted-foreground">{activity.task}</p>
                      </div>
                      <div>
                        <p className="font-medium text-foreground mb-2">Success Metric:</p>
                        <p className="text-muted-foreground">{activity.successMetric}</p>
                      </div>
                    </div>

                    <div className="flex justify-end items-center pt-4">
                      <Link href={`/day/${dayNumber}/activity/${activity.id}`}>
